...
public class Sinap{
     ...
     */
    public void adicioneCinco() throws SINAPExcepcion{
        	Area ejemplos[] = {
    ...
    public void adicione(String nombre, String name,String ubicacion, String area, String descripcion) throws SINAPExcepcion{
		if (("".equals(nombre))&&("".equals(name))&&("".equals(ubicacion))&&("".equals(area))&&("".equals(descripcion))){
			throw new SINAPExcepcion (SINAPExcepcion.ESPACIOS_VACIOS);
		}
		if("".equals(name)){
		   throw new SINAPExcepcion (SINAPExcepcion.NO_NOMBRE_INTERNACIONAL);  
	   }
	   if(getDetalles(nombre, name) != null){
    ...
    public void adicioneDetalles(Area detalles) throws SINAPExcepcion{
    	...
    	while ((i<areas.size()) && (areas.get(i).getNombre().compareToIgnoreCase(detalles.getNombre())<0)){
			if(areas.get(i).getNombre().equals(detalles.getNombre())){
				throw new SINAPExcepcion (SINAPExcepcion.AREA_REPETIDA);			
			}
    	    i++;
