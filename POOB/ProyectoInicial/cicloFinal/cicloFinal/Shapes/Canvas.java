...
public class Canvas{
     ...
     */
    public static Canvas getCanvas(int x,int y){
        if(canvasSingleton == null) {
            canvasSingleton = new Canvas("BlueJ Shapes Demo", y, x, 
                Color.white);
        }
    ...
    public void setForegroundColor(String colorString){
        if(colorString.equals("red"))
            ...
            Color newColor = new Color(0,224,93);
            graphic.setColor(newColor);
        }else if (colorString.equals("darkOrange")){
            Color newColor = new Color(222,174,255);
            graphic.setColor(newColor);; 
        }else if (colorString.equals("darkPink")){
            Color newColor = new Color(249,20,174);
            graphic.setColor(newColor);     
