...
IZPACK_JAVA_HOME=C:\Program Files\Java\jdk-14
...
# SQuirreL home.
SQUIRREL_CLI_HOME='C:\Users\57301\Documents\Universidad\CVDS\PROYECTO'/squirrelcli
...
$JAVA_HOME/bin/java -cp "$UNIX_STYLE_HOME/../lib/versioncheck.jar" JavaVersionChecker 1.8 9 10 11 12 13 14
if [ "$?" != "0" ]; then
  exit
fi
