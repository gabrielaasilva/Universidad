...
ALTER TABLE Actividad  ADD CONSTRAINT CK_Thora1 CHECK (horaInicio between 0 AND 2399);
ALTER TABLE Actividad  ADD CONSTRAINT CK_Thora2 CHECK (MOD(horaInicio,100) between 0 AND 59);
ALTER TABLE Registro  ADD CONSTRAINT CK_Thora3 CHECK (hora between 0 AND 2399);
