...
# SQuirreL home.
SQUIRREL_SQL_HOME='C:\Users\57301\Documents\Universidad\CVDS\PROYECTO'
...
$JAVACMD -cp "$UNIX_STYLE_HOME/lib/versioncheck.jar" JavaVersionChecker 1.8 9 10 11 12 13 14
if [ "$?" != "0" ]; then
	exit
fi
